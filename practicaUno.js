...
let watchList = [
 ...
 const returnMovieTitle = (watchlist) => {
    //armo filtro para que me seleccione las peliculas cuyo director sea Christopher Nolan y el rating sea mayor a 8
    const peliculasFiltradas = watchList.filter(movie => movie.Director = 'Christopher Nolan' && movie.imdbRating > 8.0)

    //de esas peliculas filtradas almaceno solo su titulo en una variable y la retorno
     const titlesArray =  peliculasFiltradas.map(movie => movie.Title);
     return titlesArray;
